...
const Login = () => {
  const {toggleAuth, getToken, isAuth, token, formData, handleChange} = useContext(authContext)
  ...
  return (
   ...
   <Button onClick={()=> navigate('/payment')}> Go to our Plans </Button> 
   <Button onClick={()=> navigate('/solution')}> Go to Home Page </Button> 
